...
def collect_raw_data(domain: str) -> dict:
    ...
    headers = {"hibp-api-key": HIBP_API_KEY, "user-agent": "PenFlow-Security-Worker"}
        ...
        findings.append(
            {
                ...
                "description": (
                    "The target domain was found in known third-party data breaches. "
                    "Associated email addresses and potentially passwords may be compromised."
                ),
                "recommendation": (
                    "Enforce strict password resets and multi-factor authentication "
