...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "form">
        ...
        <div class="penflow-submarine" aria-hidden="true">
            <img src="${url.resourcesPath}/img/submarine.png" alt="" />
        </div>

        <div id="kc-form">
            <button type="button" class="penflow-back-link"
                onclick="window.location.href = '${(client.baseUrl!"/")?js_string}';"
            >
                <span class="penflow-back-arrow" aria-hidden="true">←</span>
                <span>BACK</span>
            </button>
