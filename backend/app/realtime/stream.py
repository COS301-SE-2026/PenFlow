    ...
    try:
        ...
        mock_events = [
            {"progress": 10, "status": "running", "message": "Gathering DNS records..."},  # noqa: E501
            {
                "progress": 35,
                "status": "running",
                "message": "Querying Certificate Transparency logs (crt.sh)...",
            },  # noqa: E501
            {
                "progress": 60,
                "status": "running",
                "message": "Analyzing infrastructure via Shodan...",
            },  # noqa: E501
            {
                "progress": 85,
                "status": "running",
                "message": "Checking credential exposures (HaveIBeenPwned)...",
            },  # noqa: E501
            {
                "progress": 100,
                "status": "completed",
        ...
        for event in mock_events:
            await websocket.send_text(json.dumps({"scan_id": scan_id, **event}))
