...
| QR-05 | Unauthenticated requests to protected endpoints return 401; cross-user data access attempts (IDOR) return 403 | JWT-based auth (Auth0) with RBAC + information hiding (4.6 Security) | pytest security suite + OWASP ZAP baseline  | 401 / 403 / TBD |
...
| QR-11 | No medium-or-above risk alerts on staging from automated vulnerability scanning | Transport security (HTTPS/TLS) + information hiding — SAS 4,6  |  OWASP ZAP baseline scan | 0 medium+ / TBD
